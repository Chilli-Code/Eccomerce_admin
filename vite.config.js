  ...
  server: {
    ...
    headers: {
      "Content-Security-Policy":
        ...
        "connect-src 'self' http://localhost:3001 http://192.168.0.26:3001 https://api.cloudinary.com https://res.cloudinary.com https://*.basemaps.cartocdn.com; " +
        "frame-src 'self' https://js.stripe.com https://hooks.stripe.com;",
    },
    proxy: {
      "/widgets": {
        target: "http://192.168.0.26:3001",
        changeOrigin: true,
      },
      "/widget-bundles": {
        target: "http://192.168.0.26:3001",
